...
function Dashboard() {
  ...
  if (!currentUserDetails.isLoaded)
    return (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="font-sans mx-auto max-w-6xl px-6 py-16 lg:px-8">
        <div className="mb-16">
          ...
          <p className="mt-3 text-base text-gray-600">
            Welcome back,{" "}
            <span className="font-medium text-gray-900">{currentUserName}</span>
          </p>
        </div>
